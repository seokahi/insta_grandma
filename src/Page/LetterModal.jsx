    ...
    return (
        <div className="div-letter-modal-container" onClick={props.openModalHandler}>
                    <div className="div-letter-modal-inner-container" onClick={(e) => e.stopPropagation()}>
                        ...
                        <br/>
                        <p className="p-letter-content">우표 1개를 사용하여 답장을 확인하시겠습니까?</p>
                        <br/>
                        <div className="div-letter-modal-tel">
                            <button className="button-letter-modal-tel" onClick={onLetterhadnler}>네</button>
                            <button className="button-letter-modal-tel">아니요</button>
                        </div>
